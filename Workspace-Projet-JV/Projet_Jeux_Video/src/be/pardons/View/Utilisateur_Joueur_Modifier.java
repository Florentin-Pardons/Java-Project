...
public class Utilisateur_Joueur_Modifier extends JFrame {
	...
	public Utilisateur_Joueur_Modifier(Administrateur admin, Joueur joueur) {
		...
		txtPseudo.setBounds(99, 25, 107, 20);
		...
		txtPrenom.setBounds(99, 87, 107, 20);
		...
		txtAge.setBounds(99, 118, 107, 20);
		...
		txtadresse.setBounds(99, 149, 107, 20);
